...
returning member checking what's next.
...
**Memorable moment:** the site is a routed circuit board and the current
visibly flows from the club's name into the Join button.

**Unresolved:** real Discord URL, photos, exact kickoff details (all tracked in
PLAN.md checklist).
